...
<script type="text/javascript" src="js/app/evt_contado.js" ></script>
<script type="text/javascript">
    $(function(){
        $( "#q" ).focus();
    });
</script>
<h6 class="ui-widget-header">REGISTRO VENTA</h6>
...
<div style="margin: 0 auto; width: 660px; margin-bottom: 10px;">
    <form action="" method="GET">
        <input type="hidden" name="controller" value="contado" />
        ...
        <a href="index.php?controller=contado&action=create" class="button" > Nuevo </a>
    </form>
</div>
...
<table class="ui-widget ui-widget-content" style="width: 100%; margin: 0 auto; " >
    ...
    <tbody >
        <?php foreach ($data['rows'] as $key => $value) { ?>
            ...
            <td style='text-align:center'><a href="index.php?controller=contado&action=ver&id=<?php  echo $value[0]; ?>" title="Ver"><img alt="" src="images/shop.png" /></a></td>
            
        <?php if($value[4]==0){echo '<td style="text-align:center">-</td>';}
