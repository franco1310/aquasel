...
<h6 class="ui-widget-header">DATOS DEL DOCUMENTO</h6>
<form id="frm" action="index.php" method="POST">
    ...
    <div class="contFrm ui-corner-all" style="background: #fff;">
        <div style="margin:0 auto; width: 600px; ">
                ...
                <input type="hidden" id="idd" name="idd" class="text ui-widget-content ui-corner-all" style=" width: 200px; text-align: left;" value="<?php echo $obj->idd; ?>" readonly="readonly" />
                <br/>
