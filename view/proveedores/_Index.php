...
<h6 class="ui-widget-header">Proveedores Registrados</h6>
...
<div style="margin: 0 auto; width: 660px; margin-bottom: 10px;">
    <form action="" method="GET">
        ...
        <a href="index.php?controller=proveedores&action=create" class="button" > Nuevo </a>
    </form>
</div>
...
<table class="ui-widget ui-widget-content" style="width: 660px; margin: 0 auto; " >
    ...
    <tbody >
        ...
        <tr >
            ...
            <td style='text-align:center'><a href="index.php?controller=proveedores&action=edit&id=<?php  echo $value[0]; ?>" title="Editar"><img alt="" src="images/edit.png" /></a></td>
            <td style='text-align:center'><a href="index.php?controller=proveedores&action=show&id=<?php  echo $value[0]; ?>" title="Ver"><img alt="" src="images/delete.png" height='16' width='16' /></a></td>
        </tr>
        <?php  } ?>
    </tbody>
</table>
