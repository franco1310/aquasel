...
<h6 class="ui-widget-header">REGISTRO DE SALIDAS</h6>
...
<div style="margin: 0 auto; width: 660px; margin-bottom: 10px;">
    <form action="" method="GET">
        ...
        <a href="index.php?controller=salidas&action=create" class="button" > Nuevo </a>
    </form>
</div>
...
<table class="ui-widget ui-widget-content" style="width: 860px; margin: 0 auto; " >
    ...
    <tbody >
        ...
        <?php if($value[4]==0){echo "<tr style='color:#999;font-style:italic;background:#F3E2A9'>"; }
            ...
            <td style='text-align:center'><a href="index.php?controller=salidas&action=ver&id=<?php  echo $value[0]; ?>" title="Ver"><img alt="" src="images/shop.png" /></a></td>
