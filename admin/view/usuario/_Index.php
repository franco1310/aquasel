...
<table class="ui-widget ui-widget-content" style="width: 660px; margin: 0 auto; " >
    ...
    <tbody >
        ...
        <tr >
            ...
            <td ><a href="index.php?controller=usuario&action=edit&id=<?php  echo $value[0]; ?>" title="Editar"><img alt="" src="images/edit.png" /></a></td>
            <td ><a href="index.php?controller=usuario&action=show&id=<?php  echo $value[0]; ?>" title="Ver"><img alt="" src="images/view.png" /></a></td>
        </tr>
        <?php  } ?>
    </tbody>
</table>
